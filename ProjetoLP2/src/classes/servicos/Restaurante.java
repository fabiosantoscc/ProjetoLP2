...
public class Restaurante implements Servico, Serializable {
  ...
  */
  ...
  public Restaurante(UnidadesDoRestaurante tipo,
    ...
    /*Esse metodo eh chamado no construtor como baby sitter,
    * pois eh adicionado ao custo no momento do contrato do servico
    */
  ...
  /*
  * Verifica se o valor o valor de consumo eh valido.
  */
  ...
  */
  ...
  public void calculaDespesaTotal() {
    /*Como nos outros servicos ele primeiro verifica a estrategia para
    * depois adiciona-lo ao consumo da refeicao
    */
    estrategia = calendario.verificaEstrategia(data.get(Calendar.DAY_OF_MONTH),
  ...
  */
  ...
  public boolean equals( Object obj ) {
    ...
    return novo.getDespesaTotal() == consumoRefeicao
        && novo.getUnidadeRestaurante() == unidadeRestaurante;
  }
}