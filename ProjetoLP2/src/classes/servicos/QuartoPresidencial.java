...
public class QuartoPresidencial extends Quarto {
  ...
  private double valorDiaria = 1200.0;
  ...
  */
  ...
  public QuartoPresidencial( int quantidadeDePessoas ) throws QuantidadeDePessoasInvalidaException,
  QuartoEsgotadoNoHotelException {
  ...
  */
  ...
  public String toString() {
    return "QuartoPresidencial - Valor da diaria = R$ " + valorDiaria + ", " + super.toString();
  }
