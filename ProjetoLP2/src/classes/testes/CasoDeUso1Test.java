...
public class CasoDeUso1Test {
	...
	public void CriaObjetos() throws Exception{
			...
			hospede= new Hospede("Arnold Schwarzenegger", "35764553709", "4012888888881881", "arnold.schwarzenegger@ccc.ufcg.edu.br", telefone, endereco, data);
			...
			hospede2 = new Hospede ("Anisio", "75265471855", "4012888888881881", "moral.legal@gmail.com", telefone, endereco, data);
	}

	@Test
	public void testaCriaHospede() throws InputArgumentInvalidException, DataDeNascimentoInvalidaException{
		try {
			new Hospede("Anisio", "75265471855", "4012888888881881", "seu.email@gmail.com", telefone, endereco, data);
		...
		try {
			new Hospede ("", "75265471855", "4012888888881881", "seu.email@gmail.com", telefone, endereco, data);
		...
		try {
			new Hospede (null, "75265471855", "4012888888881881", "seu.email@gmail.com", telefone, endereco, data);
		...
		try {
			new Hospede ("An1s1o", "75265471855", "4012888888881881", "seu.email@gmail.com", telefone, endereco, data);
			Assert.fail("Esperava excecao pois o nome do hospede esta como null.");
		} catch ( StringInvalidaException e ) {
		...
		try{
			new Hospede ("Anisio", "", "4012888888881881", "seu.email@gmail.com", telefone, endereco, data);
		...
		try {
			new Hospede ("Anisio", null, "4012888888881881", "seu.email@gmail.com", telefone, endereco, data);
		...
		try {
			new Hospede ("Anisio", "123456789", "4012888888881881", "seu.email@gmail.com", telefone, endereco, data);
		...
		try {
			new Hospede ("Anisio", "abc12345678", "4012888888881881", "seu.email@gmail.com", telefone, endereco, data);
		...
		try {
			new Hospede ("Anisio", "75265471856", "4012888888881881", "seu.email@gmail.com", telefone, endereco, data);
		...
		try {
			new Hospede ("Anisio", "54797034807", "", "seu.email@gmail.com", telefone, endereco, data);
		...
		try {
			new Hospede ("Anisio", "11651145261", null, "seu.email@gmail.com", telefone, endereco, data);
		...
		try {
			new Hospede ("Anisio", "35764553709", "1234567890", "seu.email@gmail.com", telefone, endereco, data);
		...
		try {
			new Hospede ("Anisio", "37863877709", "1111111111111111", "seu.email@gmail.com", telefone, endereco, data);
		...
		try {
			new Hospede ("Anisio", "37863877709", "11112222a3334444", "seu.email@gmail.com", telefone, endereco, data);
			Assert.fail("Esperava excecao pois o numero do cartao deve conter apenas numeros.");
		} catch ( StringInvalidaException e ) {
		...
		try {
			new Hospede ("Anisio", "37863877709", "4012888888881881", "", telefone, endereco, data);
		...
		try {
			new Hospede ("Anisio", "87288982904", "5105105105105100", null, telefone, endereco, data);
		...
		try{
			new Hospede ("Anisio", "45622704545", "5105105105105100", "jose.silvagmail.com", telefone, endereco, data);
